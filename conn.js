...
const isOwner = [`${setting.ownerNumber}`,"6285752583246@s.whatsapp.net","6289509340893@s.whatsapp.net"].includes(sender) ? true : false
...
var bg_lexxy = '6285752583246@s.whatsapp.net'
...
const listMessage = {
  ...
  footer: '© created by 𝙍𝙖𝙣𝙣𝘿 official',
...
.then(data => {
var opt = { packname: '𝘽𝙤𝙩 𝙍𝙖𝙣𝙣𝘿', author: 'By 𝙍𝙖𝙣𝙣𝘿' }
